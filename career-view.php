...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
 ...
 // Insert into DB if no errors
  if (empty($errors)) {
    ...
    if ($con) {
      $stmt = $con->prepare("INSERT INTO career_single (title, description ,user_id ) VALUES (?, ?, ?)");
      ...
      if ($stmt === false) {
        ...
        if ($stmt->execute()) {
          session_flash('success', ' career_F$Q added successfully!');
...
$view_blade = "./career-view.blade.php";
