...
<img
  ...
  alt="Floating decorative bubble" />
<img
      ...
      <div class="row lg:gx-4">
        <?php foreach ($career_singles as $career_single): ?>
          <div class="lg:col-8">
            <div class="career-single-content rounded-xl bg-white p-7 shadow-lg lg:px-12 lg:py-[60px]">
              <h5 class="h5"><?= htmlspecialchars($career_single['title']); ?></h5>
              <p>
                <?= htmlspecialchars($career_single['description']); ?>
              </p>
            </div>
          </div>
        <?php endforeach; ?>
        ...
        <div class="career-single-sidebar mt-8 lg:col-4 lg:mt-0">
          ...
          <?php if (!empty($career_apply)) { ?>
            <?php foreach ($career_apply as $career_applys): ?>
              <div class="mb-8 rounded-xl bg-white py-10 px-7 shadow-lg">
                <h5 class="h5"><?= htmlspecialchars($career_applys['title']); ?></h5>
                <p class="mt-4">
                ...
                <a class="btn btn-primary mt-6 block w-full" href="apply.php?role=lead-uiux-designer">Apply Now</a>
              </div>
            <?php endforeach; ?>
          <?php } else { ?>
          ...
          <?php
            ...
            ?>
              ...
              <div class="mb-8 rounded-xl bg-white py-10 px-7 shadow-lg">
                <h5 class="h5"><?= htmlspecialchars($career['title']); ?></h5>
                <p class="mt-6">
