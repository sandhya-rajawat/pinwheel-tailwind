...
include './function.php'; // Contains db_connect() function
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT password FROM profile WHERE user_id = ?");
    ...
    if (!$user) {
        ...
        $stmt = $conn->prepare("UPDATE profile SET password = ? WHERE user_id = ?");
