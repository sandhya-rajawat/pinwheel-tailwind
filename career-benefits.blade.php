...
<section class="page-hero pt-16 pb-6">
  <div class="container">
    ...
    <div class="page-hero-content mx-auto max-w-[768px] text-center">
      <h1 class="mb-5 mt-8">Add New Competitive salary</h1>
    </div>
  </div>
</section>
...
<section class="section pt-0 min-h-screen flex items-center justify-center">
  <div class="container flex flex-col items-center justify-center">
    ...
    <div class="md:col-6 md:order-1">
      <form class="lg:max-w-[484px] w-full" action="./career-benefits.php" method="POST" enctype="multipart/form-data">
