...
?>
        <div class="mb-8  lg:w-1/4  md:col-6 ">
              ...
              <!-- <div class="card h-10px"> -->
                <!-- Image -->                
                <img id="image" class="card-img w-full h-[180px] object-cover rounded-lg" 
                     src="./uploads/<?php echo $blog['thumbnail']; ?>" 
                     alt="Blog Image">
               ...
               <?= $blog['title']; ?>
                  ...
                  <div class="card-footer mt-6 flex space-x-4">
                    <span class="inline-flex items-center text-xs text-[#666]">
                      ...
                      <p class="text-lg text-gray-700"><small><?php echo ($blog['updated_at']); ?></small></p>
                    </span>
                    <span class="inline-flex items-center text-xs text-[#666]">
                      ...
                      <p class="text-lg text-gray-700"><small><?php echo ($blog['created_at']); ?></small></p>
                    </span>
                  </div>
                </div>
              </div>
...
?>
        </div> <!-- Close .featured-posts -->
       </div> <!-- Close .container -->
    </section> <!-- Close .section -->
<?php     
    } else {
        echo("data is not fine!!");
    }
?>
