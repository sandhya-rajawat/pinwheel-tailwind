        ...
        <div class="featured-posts row">
          <div class="mb-8 md:col-6">
            <div class="card">
              <!-- image -->
            <img src=''>
              <img class="card-img" width="235" height="304" 
                   src="./uploads/<?php echo $blog['thumbnail']; ?>" alt="Blog Image">
              ...
              <div class="card-content">
                ...
                <div class="card-footer mt-6 flex space-x-4">
                  <span class="inline-flex items-center text-xs text-[#666]">
                    ...
                    <!-- updated_at -->
                    <p><small>Posted on: <?php echo ($blog['updated_at']); ?></small></p>
                  </span>
                  <span class="inline-flex items-center text-xs text-[#666]">
                    <svg
                      class="mr-1.5"
                    ...
                    <!-- 'created_at -->
                    <p><small>Posted on: <?php echo ($blog['created_at']); ?></small></p>
                  </span>
                </div>
              </div>
            </div>
