...
<section class="page-hero pt-16 pb-6">
  <div class="container">
    ...
    <div class="page-hero-content mx-auto max-w-[768px] text-center">
      <h1 class="mb-5 mt-8">Edit Profile</h1>
    </div>
  </div>
</section>
...
<div style="padding: 20px;" class="headofinput">
 ...
 <form method="post"  action="profile-edit.php">
    Name: <input  class="name"type="text" name="fullname" value="<?= htmlspecialchars($user['fullname']);?>"><br><br>
    Email: <input class="email" type="email" name="email" value="<?= htmlspecialchars($user['email'] ?? '') ?>"><br><br>
    Password: <input class="password" type="password" name="password" value="<?= htmlspecialchars($user['password'] ?? '') ?>"><br><br>
